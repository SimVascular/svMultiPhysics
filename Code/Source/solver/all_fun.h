...
namespace all_fun {
  ...
  double integ(const ComMod& com_mod, const CmMod& cm_mod, int dId, const Array<double>& s, int l, int u, 
      const Array<double>* Do, bool pFlag=false);

  double integ(const ComMod& com_mod, const CmMod& cm_mod, const faceType& lFa, const Vector<double>& s,
      const Array<double>* Dn, const Array<double>* Do, bool pFlag=false, consts::MechanicalConfigurationType cfg=consts::MechanicalConfigurationType::reference);

  double integ(const ComMod& com_mod, const CmMod& cm_mod, const faceType& lFa, const Array<double>& s,
      const int l, const Array<double>* Dn, const Array<double>* Do, std::optional<int> uo=std::nullopt, bool THflag=false, consts::MechanicalConfigurationType cfg=consts::MechanicalConfigurationType::reference);

  double integ(const ComMod& com_mod, const CmMod& cm_mod, const faceType& lFa, const Array<double>& s, const Array<double>* Dn, const Array<double>* Do, consts::MechanicalConfigurationType cfg=consts::MechanicalConfigurationType::reference);
