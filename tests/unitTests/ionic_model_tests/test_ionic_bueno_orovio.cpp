 ...
 * EPI reference is generated independently by
 * @c reference_generators/ionic_model/bueno_orovio/generate_bueno_orovio.py,
 * not by svMultiPhysics. See @ref BuenoOrovio for model details.
 */
 ...
 * The test applies @f$I_\mathrm{stim}=-35.714@f$ for
 * @f$10\leq t<12\,\mathrm{ms}@f$ and sets @f$K_\mathrm{sac}=0@f$. The trusted
 * ENDO reference is generated independently by
 * @c reference_generators/ionic_model/bueno_orovio/generate_bueno_orovio.py,
 * not by svMultiPhysics. See @ref BuenoOrovio for model details.
 */
 ...
 * The test applies @f$I_\mathrm{stim}=-35.714@f$ for
 * @f$10\leq t<12\,\mathrm{ms}@f$ and sets @f$K_\mathrm{sac}=0@f$. The trusted
 * M-cell reference is generated independently by
 * @c reference_generators/ionic_model/bueno_orovio/generate_bueno_orovio.py
 * and intentionally uses the current svMultiPhysics
 * @f$\tau_{s2}=2\,\mathrm{ms}@f$ default; see the warning in
 * @ref BuenoOrovio. The values are not generated by svMultiPhysics.
 */
