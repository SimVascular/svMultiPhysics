...
// Default parameters are for epicardium state (source:
// https://models.cellml.org/e/80d)
const TTP::State TTP::State::default_initial_state = {.V = -85.23,
                                                      .K_i = 136.89,
                                                      .Na_i = 8.6040,
                                                      .Ca_i = 1.26E-4,
                                                      .Ca_ss = 3.6E-4,
...
void TTP::set_initial_conditions(const TTPInitialConditionsParameters &params) {
...
void TTP::init(const int nX, const int nG, Vector<double> &X,
