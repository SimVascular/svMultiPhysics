...
def csv_text(states: list[State]) -> str:
    lines = [
        "# Provenance: independent Python Forward-Euler transcription of the",
        "# svMultiPhysics FitzHugh-Nagumo equations; not generated by svMP.",
        "# Formulation: Goktepe & Kuhl (2009), doi:10.1002/nme.2571, Eqs. 14--15.",
        "# Parameters: alpha=-0.5, a=0, b=-0.6, c=50.",
        "# Initial state: exact equilibrium u=0, w=0.",
        "# Protocol: dt=0.0005, 3000 FE updates, I_stim=0.5 for",
        "# 0.10 <= t < 0.12 (old-state time), I_stim=0 otherwise, and Ksac=0.",
        "# The equilibrium is unstable; the trajectory stops at t=1.5 during",
        "# late first-cycle recovery and before the next autonomous upstroke.",
