...
def write_oracle(output: Path, samples: dict[float, tuple[float, float]]) -> None:
    ...
    with output.open("w", newline="", encoding="utf-8") as stream:
        stream.write(
            "# Provenance: independent Forward-Euler implementation of the split\n"
            "# Aliev-Panfilov formulation in Goktepe & Kuhl (2009); not generated by svMP.\n"
            "# Protocol: default resting state, dt=0.1 ms, 6000 updates, Ksac=0.\n"
            "# Stimulus: Istim=-35.714 for 10 <= t < 12 ms; zero otherwise.\n"
            "# Initial state: V_mV=-80, w=0.001.\n"
